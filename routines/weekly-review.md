...
- **先週・先々週の回 (§1-2 で読んだ WEEKLY_REVIEW.md 直近回) と同じテーマ・同じ来週の主役・同じ気になることを繰り返さない**。今週動いた差分 (新しい commit / 完了 / 状態変化) を軸にする。同じ案件が 3 週以上「気になっている」まま動いていなければ、restate でなく「N 週停滞、着手か見送りの判断を」と踏み込む
